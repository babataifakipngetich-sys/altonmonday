  ...
  return (
    <section id="gallery" className="section-padding bg-white">
      <div className="container-custom">
        ...
        {/* Grid — uniform aspect ratio, no row-span */}
        <motion.div
          initial={{ opacity: 0 }}
      ...
      {lightboxOpen && (
        ...
        >
          <button
            onClick={() => setLightboxOpen(false)}
            className="absolute top-4 right-4 z-10 text-white/70 hover:text-white bg-white/10 backdrop-blur-sm rounded-full p-2.5 transition-colors"
            aria-label="Close"
          >
            <X className="w-5 h-5" />
          </button>
          <button
            ...
            className="absolute left-3 top-1/2 -translate-y-1/2 z-10 text-white/70 hover:text-white bg-white/10 backdrop-blur-sm rounded-full p-2.5 transition-colors"
            aria-label="Previous"
          >
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 z-10 text-white/70 hover:text-white bg-white/10 backdrop-blur-sm rounded-full p-2.5 transition-colors"
            aria-label="Next"
          >
          ...
          <div className="w-full max-w-4xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex justify-center gap-2 mt-4 overflow-x-auto pb-1">
              {filtered.map((img, idx) => (
                ...
                >
                  <Image src={img.src} alt={img.title} fill sizes="56px" className="object-cover" />
                </button>
              ))}
            </div>
          </div>
