                  ...
                  {MEAL_PLAN_ORDER.map((plan, planIdx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-4">
                          <span
                            className={cn(
                              ...
                              isHighlighted ? 'bg-white/20 text-white' : 'bg-royal-50 text-royal-500'
                            )}
                          >
                        ...
                        <p className={cn('text-sm font-medium mb-1', isHighlighted ? 'text-white' : 'text-gray-700')}>
                          {plan}
                        </p>
                        <p className={cn('text-xs mb-4 leading-relaxed', isHighlighted ? 'text-white/70' : 'text-gray-400')}>
                          {MEAL_PLAN_DESCRIPTIONS[plan]}
                        </p>

                        <div className="mt-auto">
                          <div className="flex items-baseline gap-1 mb-4">
                            <span className={cn('font-playfair text-2xl font-bold', isHighlighted ? 'text-gold-300' : 'text-royal-500')}>
                              {formatKES(product.price)}
                            </span>
                            <span className={cn('text-xs', isHighlighted ? 'text-white/60' : 'text-gray-400')}>/night</span>
                          </div>
