      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-gray-600 mt-3 sm:mt-4 max-w-2xl mx-auto text-sm sm:text-base px-4">
            Modern meeting spaces equipped with state-of-the-art technology for corporate events, workshops, and team-building activities.
          </p>
        </motion.div>
        ...
        >
          <div className="relative h-48 sm:h-80 md:h-96">
            <img src="/images/conference/conference/con1.jpg" alt="Conference facilities" className="w-full h-full object-cover" />
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8 text-white">
            ...
            <p className="text-white/80 text-xs sm:text-sm md:text-base">Fully equipped conference rooms for successful business events</p>
          </div>
        </motion.div>
        ...
        >
          <button onClick={onBookNow} className="bg-royal-500 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-md text-sm sm:text-base font-semibold hover:bg-royal-600 transition-colors">
