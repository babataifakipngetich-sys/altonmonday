...
const testimonials = [
  { name: 'John Oketch', rating: 5, review: 'Exceptional hospitality and beautiful rooms. The staff went above and beyond to make our stay memorable. The food was delicious and the pool area is stunning. Highly recommended!', date: '2 months ago', avatar: 'JO' },
  { name: 'Mary Atieno', rating: 5, review: 'The perfect place for conferences and family vacations. Modern facilities, great internet, and the conference rooms are well equipped. Will definitely be back!', date: '1 month ago', avatar: 'MA' },
  { name: 'Peter Ochieng', rating: 5, review: 'Amazing food and professional staff. Truly unforgettable experience. The restaurant serves both local and international dishes with great attention to detail.', date: '3 weeks ago', avatar: 'PO' },
  { name: 'Grace Adhiambo', rating: 5, review: 'We had our wedding here and it was absolutely magical! The garden setup was beautiful, the coordination team was professional, and our guests were impressed.', date: '1 month ago', avatar: 'GA' },
  { name: 'Michael Otieno', rating: 5, review: 'Clean rooms, excellent service, and the location is perfect - just a short drive from the airport. The airport transfer service was very convenient.', date: '2 weeks ago', avatar: 'MO' },
  { name: 'Sarah Nyawanda', rating: 5, review: 'The Presidential Suite exceeded all expectations. Luxurious amenities, stunning views, and personalized service. Worth every penny for a special occasion!', date: '3 months ago', avatar: 'SN' },
];
                ...
                <div className="bg-gray-50 rounded-xl p-4 sm:p-6 h-full">
                  ...
                  <div className="flex items-center gap-1 mb-3 sm:mb-4">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-4 h-4 sm:w-5 sm:h-5 ${i < testimonial.rating ? 'text-gold-400 fill-gold-400' : 'text-gray-300'}`}
                      />
                    ))}
                  </div>
