...
const diningOptions = [
  { icon: UtensilsCrossed, title: 'Local Cuisine', description: 'Authentic Kenyan dishes prepared with fresh, locally sourced ingredients.' },
  { icon: Wine, title: 'Continental Cuisine', description: 'International flavors crafted by our expert culinary team.' },
  { icon: Sunrise, title: 'Breakfast Buffet', description: 'Start your day with our lavish breakfast spread.' },
  { icon: Coffee, title: 'Bar & Lounge', description: 'Premium beverages and signature cocktails.' },
];
      ...
      <div className="container-custom">
        <div ref={ref} className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative h-[350px] sm:h-[400px] lg:h-[550px]"
          >
            <motion.div
            ...
            >
              <img src="/images/dining/dining/din1.jpg" alt="Restaurant interior" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            ...
            >
              <img src="/images/dining/dining/din2.jpg" alt="Signature dishes" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-royal-900/50 to-transparent" />
              <div className="absolute top-3 sm:top-4 left-3 sm:left-4">
                <span className="bg-gold-400 text-royal-900 text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-1 sm:py-1.5 rounded-full">SIGNATURE DISHES</span>
              </div>
            </motion.div>
            ...
            >
              <img src="/images/dining/dining/din3.jpg" alt="Bar & cocktails" className="w-full h-full object-cover" />
        ...
        >
          <div className="relative h-48 sm:h-64 md:h-80">
            <img src="/images/dining/dining/din3.jpg" alt="Outdoor dining experience" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="absolute inset-0 bg-gradient-to-r from-royal-900/90 via-royal-900/50 to-transparent flex items-center">
            <div className="p-6 sm:p-8 md:p-12 max-w-xl">
              ...
              <p className="text-white/80 mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base hidden sm:block">
                Enjoy your meals in our beautiful garden setting with stunning views and fresh air. Perfect for romantic dinners and special occasions.
              </p>
              <button onClick={onReserveTable} className="inline-flex items-center gap-2 text-gold-400 font-semibold text-sm sm:text-base hover:text-gold-300 transition-colors">
