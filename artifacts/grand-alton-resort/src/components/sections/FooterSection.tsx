        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a href={link.href} className="text-white/70 hover:text-gold-400 transition-colors">
                    {link.name}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {services.map((service) => (
                <li key={service.name}>
                  <a href={service.href} className="text-white/70 hover:text-gold-400 transition-colors">
                    {service.name}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/70">Otonglo, behind Kodiaga Prison, Kisumu, Kenya</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-gold-400" />
                <a href="tel:+254794000020" className="text-white/70 hover:text-gold-400 transition-colors">+254 794 000 020</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-gold-400" />
                <a href="mailto:thegrandaltonresort@gmail.com" className="text-white/70 hover:text-gold-400 transition-colors">thegrandaltonresort@gmail.com</a>
              </li>
            </ul>
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center">
                  <svg width="48" height="32" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M24 8.5C26.4 10.2 28 13 28 16C28 19 26.4 21.8 24 23.5C21.6 21.8 20 19 20 16C20 13 21.6 10.2 24 8.5Z" fill="#FF5F00"/>
                  </svg>
                </div>
