    ...
    <section id="contact" className="section-padding bg-gray-50">
      <div className="container-custom">
        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <h3 className="font-playfair text-2xl font-bold text-royal-500 mb-6">
              Contact Information
            </h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Otonglo, behind Kodiaga Prison,<br />
                    Kisumu, Kenya
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+254794000020" className="text-gray-600 hover:text-gold-400 transition-colors">
                    +254 794 000 020
                  </a>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-royal-500 rounded-full flex items-center justify-center text-white hover:bg-gold-400 hover:text-royal-900 transition-colors"
                >
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
              ...
              {submitted ? (
                ...
                >
                  ...
                  <h4 className="font-playfair text-xl font-bold text-royal-500 mb-2">
                    Message Sent!
                  </h4>
                  <p className="text-gray-600">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-royal-500 focus:border-transparent transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-royal-500 focus:border-transparent transition-all resize-none"
                  ...
                  <button
                    ...
                    className="w-full bg-royal-500 text-white py-4 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-royal-600 transition-colors disabled:bg-gray-400"
                  >
                    {isSubmitting ? (
                      'Sending...'
                    ) : (
